...
import com.example.end.bean.UserInfo;
import com.example.end.database.UserDBHelper;
import com.example.end.util.DateUtil;
import com.example.end.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    private String[] typeArray = {"个人用户", "公司用户","18990095 段璎宴"};
