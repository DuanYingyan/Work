...
import com.example.end.adapter.RecyclerStaggeredAdapter;
import com.example.end.constant.ImageList;
import com.example.end.util.StatusBarUtil;
import com.example.end.util.Utils;
import com.example.end.widget.BannerPager;
...
import com.example.end.adapter.RecyclerGridAdapter;
import com.example.end.bean.GoodsInfo;
import com.example.end.widget.SpacesItemDecoration;
