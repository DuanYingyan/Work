...
import com.example.shoppingcart.adapter.GoodsGridAdapter;
...
public class GridViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Goods> planetList = Goods.getDefaultList();
        // 构建一个行星队列的网格适配器
        GoodsGridAdapter adapter = new GoodsGridAdapter(this, planetList);
